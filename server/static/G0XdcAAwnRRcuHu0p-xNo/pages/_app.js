...
const Layout = props => {
  return __jsx(head_default.a, null, __jsx("title", null, "Next.js App"), __jsx("link", {
    rel: "icon",
    href: "/favicon.ico"
  }), __jsx("meta", {
    name: "viewport",
...
class _app_MyApp extends app_default.a {
  render() {
    ...
    return _app_jsx(external_react_default.a.Fragment, null, _app_jsx(components_Layout, null), _app_jsx(Component, pageProps));
  }
